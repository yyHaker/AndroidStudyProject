...
public class MainActivity extends Activity {
        ...
        new Thread(){
            public void run() {
                ...
                try {
                    ...
                    //解析成List<ShopInfo>
                    data = new Gson().fromJson(jsonString, new TypeToken<List<ShopInfor>>(){}.getType());
                    //3. 主线程, 更新界面
    ...
    private String requestJson() throws Exception {
        String result = null;
        String path = "http://192.168.253.1:8081/L05_Web/ShopInfoListServlet";
        //1. 得到连接对象
    ...
    class ShopInfoAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            //得到当前行的数据对象
            ShopInfor shopInfo = data.get(position);
            //得到当前行的子View
